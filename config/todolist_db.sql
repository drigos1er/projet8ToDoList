...
--
-- Hôte : localhost:8889
-- Généré le :  lun. 15 fév. 2021 à 16:44
...
--
CREATE DATABASE IF NOT EXISTS `todolist_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `todolist_db`;
...
(1, 1, '2021-01-22 05:36:15', 'test', 'test test', 0),
(3, 5, '2021-02-10 00:00:00', 'tache1', 'test tache 1', 0),
(4, 5, '2021-02-10 00:00:00', 'tache2', 'test tache 2', 0),
(5, 5, '2021-02-10 00:00:00', 'tache 3', 'test tache 3', 0),
(6, 5, '2021-02-10 00:00:00', 'tache 4', 'test tache 4', 0);
...
(1, 'usert2', '$2y$13$vLdiqFgb9lTyPXOCeJHkTuL0EPs9biqXeNnxaS5jLJlkdQykj0UsW', 'usert2@test.ci', '1'),
(3, 'userblack', '$2y$13$6tZ24pxIJh0S2ueHLozxMee0KtcHX/FexxbtWpG6MrXZeBrB/M1Ea', 'userblack@yahoo.fr', '2'),
(5, 'anonyme', '$2y$13$6tZ24pxIJh0S2ueHLozxMee0KtcHX/FexxbtWpG6MrXZeBrB/M1Ea', 'anonyme@todo.ci', '2'),
(6, 'drigos1er', '$2y$13$1ji5d740QDVEUSElUQRwhu1Te1Bx1ZE/lKc9aRIch0MAm.h.oJJwO', 'drigos1er@gmail.com', '1'),
(7, 'usersout', '$2y$13$BQbfpdMzCcAA0u4rnTL//ersbM.tkCJmk.GwCId69yEgWRPo80LDK', 'usersout@todo.ci', '2'),
