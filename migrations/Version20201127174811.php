 ...
 */
final class Version20201127174811 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE task CHANGE user_id users_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE task CHANGE users_id user_id INT DEFAULT NULL');
